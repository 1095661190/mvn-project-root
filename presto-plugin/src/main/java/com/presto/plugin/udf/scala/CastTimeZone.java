...
public class CastTimeZone {
  ...
  public static Slice ctimezone(@SqlType(value = "varchar") Slice datetime,
      @SqlType(value = "varchar") Slice timeZone2) {
    ...
    try {
      ...
      return Slices
          .copiedBuffer((String) toFormat.format(midDate), (Charset) StandardCharsets.UTF_8);
