 ...
 */
package com.presto.plugin.udf.scala;
...
public class IpLookup {
  ...
  public static Slice geoip(@SqlType(value = "varchar") Slice category,
      @SqlType(value = "varchar") Slice ip) {
    ...
    switch (categoryStr.toLowerCase()) {
      case "country": {
        return Slices.copiedBuffer((String) countryLookup.getCountry(ip.toStringUtf8()).getName(),
      ...
      case "city": {
        ...
        return Slices.copiedBuffer((String) (location.city == null ? "bi_null" : location.city),
            (Charset) StandardCharsets.UTF_8);
      }
      case "latitude": {
        Location l0 = cityLookup.getLocation(ip.toStringUtf8());
        return Slices.copiedBuffer((String) (l0 == null ? "" + -1 : "" + l0.latitude),
            (Charset) StandardCharsets.UTF_8);
      }
      case "longitude": {
        Location l1 = cityLookup.getLocation(ip.toStringUtf8());
        return Slices.copiedBuffer((String) (l1 == null ? "" + -1 : "" + l1.longitude),
            (Charset) StandardCharsets.UTF_8);
      }
      case "region": {
